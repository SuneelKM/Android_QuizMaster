...
class ChooseQuizActivityTest {

    @get:Rule
    var activityScenarioRule = activityScenarioRule<ChooseQuizActivity>()


    // layout is displayed to the user
    @Test
    fun checkingActivity(){
        Espresso.onView(ViewMatchers.withId(R.id.ChooseQuiz))
    ...
    fun navigateTo2Activity() {
        Espresso.onView(ViewMatchers.withId(R.id.ChooseQuiz)).perform(ViewActions.click())
        Espresso.onView(ViewMatchers.withId(R.id.ChooseQuiz)).perform(ViewActions.click()) }
